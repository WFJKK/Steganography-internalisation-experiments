"""
Sentence Length Steganography - V0/V1/V2 Data Generator (OpenAI version)
=========================================================================
Uses OpenAI API (GPT-4o-mini) instead of Anthropic.

Usage:
  export OPENAI_API_KEY="sk-proj-..."

  # Test:
  python generate_sentlen_v0v1v2_openai.py --variant v0 --source-data data/acrostics/v0/train.jsonl --output /tmp/test.jsonl --limit 5

  # Full:
  python generate_sentlen_v0v1v2_openai.py --variant v0 --source-data data/acrostics/v0/train.jsonl --output data/sentlen/v0/train.jsonl --resume
"""
...
# -----------------------------------------------
# Bit derivation (identical to synonym/acrostic)
# -----------------------------------------------
...
def main():
    parser = argparse.ArgumentParser(description="Generate sentence length V0/V1/V2 data (OpenAI)")
